...
public enum ErrorCode {
  ...
  FAIL_TO_DELETE_COURSE(HttpStatus.BAD_REQUEST, "게시글 삭제에 실패했습니다."), FAIL_TO_LIKE_COURSE(HttpStatus.BAD_REQUEST, "코스 좋아요 실패."), FAIL_TO_UNLIKE_COURSE(HttpStatus.BAD_REQUEST, "코스 좋아요 취소 실패.");
